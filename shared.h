...
//		uint64_t avg;
	...
	static const char *time_name[] = {"INSERT_ENTRY_TO_SLOT","DIRECT_TO_COLD","INSERT_TO_COLD_OF_DTC","INSERT_TO_COLD_FORM_WARM","INSERT_TO_COLD","APPEND_OF_ITC","SPLIT_OF_ITC","TEMP1","TEMP2","TEMP3","TEMP4","DRAM","PMEM","VERSION","INSERT","READ","SKIP_LOCK","INESRT_LOG","INSERT_DTC","TIME_LIST_END"};
