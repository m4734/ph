...
ph: kvs_ph test/test.h test/test.c
	...
	g++ -o bin/test test/test.o ph/global.o ph/data.o ph/hash.o ph/query.o ph/thread.o -lpthread -lpmem -O3

kvs_ph: ph/kvs.h ph/global.h ph/global.c ph/data.h ph/data.c ph/hash.h ph/hash.c ph/thread.c ph/thread.h
	g++ -c -o ph/data.o ph/data.c -O3
	g++ -c -o ph/hash.o ph/hash.c -O3
	g++ -c -o ph/query.o ph/query.c -O3
	g++ -c -o ph/global.o ph/global.c -O3
	g++ -c -o ph/thread.o ph/thread.c -O3
...
debug_ph: debug_kvs_ph test/test.h test/test.c
	...
	g++ -g -o bin/test test/test.o ph/global.o ph/data.o ph/hash.o ph/query.o ph/thread.o -lpthread -lpmem

debug_kvs_ph: ph/kvs.h ph/global.h ph/global.c ph/data.h ph/data.c ph/hash.h ph/hash.c ph/thread.c ph/thread.h
